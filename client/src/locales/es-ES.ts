export const esES = {
  ...
  team: {
    ...
    noPlayersAvailableForBench: "No hay jugadores disponibles para el banquillo",
    noPlayersInStartingLineup: "No hay jugadores en la alineación titular",
  ...
  toasts: {
    ...
    welcomeToCancha: "Bienvenido a Cancha+, {{name}}",
    letsCompleteOnboarding: "Completemos tu proceso de registro",
