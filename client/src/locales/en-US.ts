export const enUS = {
  ...
  settings: {
    ...
    players: "Players",
    playersDescription: "Team player roster",
    ...
    manageTeamInformation: "Manage your team information and settings",
    teamName: "Team Name",
    division: "Division",
    regenerateJoinCode: "Regenerate Join Code",
    joinCode: "Join Code",
    joinCodeDescription: "Share this code with new members to join your team",
  ...
  toasts: {
    ...
    welcomeToCancha: "Welcome to Cancha+, {{name}}",
    letsCompleteOnboarding: "Let's complete your onboarding process",
