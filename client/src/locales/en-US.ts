export const enUS = {
  ...
  settings: {
    ...
    logo: "Logo",
    joinCode: "Join Code",
    joinCodeDescription: "Members can use this code to join your team during registration",
    regenerateJoinCode: "Regenerate Code",
    copyToClipboard: "Copy to Clipboard",
    showCode: "Show Code",
    hideCode: "Hide Code",
    joinCodeRegenerated: "Join code regenerated",
    joinCodeRegeneratedDescription: "New join code successfully generated",
    copiedToClipboard: "Copied to clipboard",
    clipboardDescription: "Team join code has been copied to clipboard",
    name: "Name",
    position: "Position",
    contact: "Contact",
    actions: "Actions",
    teamUpdated: "Team updated",
    teamUpdatedDescription: "Team settings have been updated successfully.",
    ...
    logoUpdatedDescription: "Your team logo has been updated successfully.",
    manageTeamInformation: "Manage your team's information and preferences",
    ...
    confirmDeleteMember: "Are you sure you want to remove this member from the team?",
    deleteWarning: "This action cannot be undone. The member will lose access to the team.",
    confirmDelete: "Confirm Deletion",
  },
  seasons: {
    title: "Seasons",
    description: "Manage your team's seasons and view season-specific standings",
    newSeason: "New Season",
    createNewSeason: "Create New Season",
    seasonName: "Season Name",
    seasonNamePlaceholder: "2023-2024 Season",
    ...
    noStandingsDescription: "Use the \"League Standings\" tab to add teams to the standings for this season.",
    pos: "Pos",
    team: "Team",
    p: "P",
    w: "W",
    ...
    gd: "GD",
    pts: "Pts",
    createFirst: "Create a season first to manage matches",
    createSeasonFirst: "You need to create a season first to manage matches",
