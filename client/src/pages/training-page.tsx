...
import { Loader2, PlusCircle, CheckCircle, XCircle, Clock, MapPin } from "lucide-react";
...
export default function TrainingPage() {
  ...
  const form = useForm<TrainingFormData>({
    ...
    defaultValues: {
      ...
      endTime: new Date(new Date().getTime() + 90 * 60 * 1000).toISOString().slice(0, 16),
      location: "",
      description: "",
      type: "training",
    },
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Enter training session title" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    {eventsForSelectedDate.length === 0 ? (
                      ...
                      <div className="space-y-4">
                        {eventsForSelectedDate.map(event => (
                          <div key={event.id} className="bg-background p-4 rounded-lg">
            ...
            <TabsContent value="list" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {trainingEvents.length} training session{trainingEvents.length !== 1 ? 's' : ''} scheduled
                  </CardDescription>
                </CardHeader>
                <CardContent>
                            ...
                            <div className="bg-primary/5 px-4 py-2 flex justify-between items-center border-b">
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-500">{format(new Date(event.startTime), "EEEE, MMMM d, yyyy")}</p>
                                </div>
                              </div>
                              <div>
